...
<head>
    ...
    <title>AURA - Celestial Oud</title>
    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">CELESTIAL OUD</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    CELESTIAL OUD is a luxurious oriental fragrance that transports the wearer to distant, mystical lands. 
                    Its top notes reveal a luminous mix of saffron and bergamot, radiating warmth and sophistication. 
                    The heart unfurls with rich oud, intertwined with subtle hints of rose and spicy cardamom, evoking 
                    an aura of elegance and depth. As the fragrance dries, the base of creamy sandalwood, amber, and 
                    soft vanilla wraps the senses in a sensual, lingering veil, leaving a majestic and unforgettable trail. 
                    Perfect for evening occasions, Celestial Oud embodies opulence, mystery, and refinement.
                </p>
            </section>

            <section class="product-ingredients-2col">
                <div>Alcohol Denat. (Carrier) 75.0%</div>
                <div>Aquilaria Agallocha Oil (Oud) 6.0%</div>
                <div>Citrus Aurantium Bergamia Peel Oil (Bergamot) 3.0%</div>
                <div>Crocus Sativus Extract (Saffron) 2.5%</div>
                <div>Rosa Damascena Flower Oil (Rose) 3.0%</div>
                <div>Elettaria Cardamom Seed Oil (Cardamom) 2.0%</div>
                <div>Santalum Album Oil (Sandalwood) 4.0%</div>
