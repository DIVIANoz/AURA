    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">MOSS</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    MOSS is a grounded and earthy fragrance inspired by dense forest walks after rainfall. The opening
                    combines green notes of oak leaves and fresh basil, creating a vibrant natural scent. The heart
                    features soft fern, moss, and a touch of clary sage, evoking the feeling of deep woodland. The base
                    is rich with vetiver, amber, and soft cedarwood, leaving a lingering earthy trail that is
                    sophisticated yet approachable. MOSS is ideal for those seeking a fragrance that is calming,
                    elegant, and deeply connected to nature.
                </p>
            </section>

            <section class="product-ingredients-2col">
                <div>Alcohol Denat. (Carrier) 75.0%</div>
                <div>Quercus Robur Leaf Extract (Oak Leaves) 3.0%</div>
                <div>Ocimum Basilicum Extract (Basil) 2.5%</div>
                <div>Adiantum Capillus-Veneris Extract (Fern) 2.0%</div>
                <div>Clary Sage Oil 2.5%</div>
