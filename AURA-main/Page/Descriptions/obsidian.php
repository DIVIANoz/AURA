    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">OBSIDIAN</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    OBSIDIAN is a deep, mysterious fragrance for those who seek elegance with a hint of enigma. Its
                    top notes of blackcurrant, bergamot, and a touch of mandarin create an alluring opening. The heart
                    reveals a rich blend of smoked oud, dark chocolate, and leather, evoking sophistication and boldness.
                    The base settles into warm amber, patchouli, and soft sandalwood, leaving a long-lasting, refined
                    trail. Perfect for evening wear, OBSIDIAN is a fragrance that commands attention and leaves an
            ...
            <section class="product-ingredients-2col">
                ...
                <div>Citrus Reticulata Oil (Mandarin) 2.0%</div>
                <div>Agarwood Oil (Oud) 3.5%</div>
                <div>Theobroma Cacao Extract (Dark Chocolate) 2.5%</div>
                <div>Leather Accord 2.0%</div>
                <div>Pogostemon Cablin Leaf Oil (Patchouli) 2.5%</div>
