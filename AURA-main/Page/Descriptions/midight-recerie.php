...
<head>
    ...
    <title>AURA - Midnight Recerie</title>
    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">MIDNIGHT RECERIE</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    MIDNIGHT RECERIE is a mysterious nocturnal fragrance that evokes the quiet elegance of the night.
                    It opens with dark plum, blackcurrant, and a hint of bergamot, creating a rich and deep introduction.
                    The heart combines night-blooming jasmine, violet, and soft iris petals for a floral, slightly sweet
                    character. The base reveals warm amber, sandalwood, and patchouli, giving depth and longevity to
                    the scent. Perfect for evening events or intimate gatherings, this fragrance leaves a sophisticated
                    and lingering impression that enchants the senses.
                </p>
            </section>

            <section class="product-ingredients-2col">
                <div>Alcohol Denat. (Carrier) 75.0%</div>
                <div>Prunus Domestica Extract (Dark Plum) 3.0%</div>
                <div>Ribes Nigrum Extract (Blackcurrant) 2.5%</div>
                <div>Citrus Aurantium Bergamia Peel Oil (Bergamot) 2.0%</div>
                <div>Jasminum Nightflower Extract (Night Jasmine) 2.5%</div>
                <div>Viola Odorata Flower Extract (Violet) 2.0%</div>
                <div>Iris Pallida Root Extract (Iris) 2.5%</div>
                <div>Ambroxan 2.0%</div>
                <div>Santalum Album Oil (Sandalwood) 2.0%</div>
            </section>
        </div>
    </main>
