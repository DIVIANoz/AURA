    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">DAWN</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    DAWN is a crisp and refreshing fragrance designed to evoke the serene beauty of the early morning. 
                    Its bright top notes feature a blend of lemon zest, green apple, and dewy pear, offering an invigorating 
                    opening. The heart reveals delicate white florals such as lily, jasmine, and freesia, adding a gentle 
                    floral elegance. The base settles into soft woods, musk, and amber, creating a warm and grounding finish 
                    that lingers lightly on the skin. Ideal for daily wear, DAWN embodies freshness, optimism, and the 
