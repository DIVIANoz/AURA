    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">LUNA</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    LUNA is a celestial-inspired fragrance capturing the mystical beauty of moonlit nights. It opens
                    with crisp top notes of bergamot, white peach, and a soft hint of lavender, evoking serenity and
                    tranquility. The heart blends delicate rose petals, freesia, and violet, creating an elegant floral
                    embrace. The base is composed of creamy sandalwood, white musk, and a whisper of amber, leaving a
                    luminous and captivating trail. Perfect for evening wear, LUNA embodies sophistication, grace, and
                    ethereal charm.
                </p>
            </section>
            ...
            <section class="product-ingredients-2col">
                ...
                <div>Prunus Persica Extract (White Peach) 2.5%</div>
                <div>Lavandula Angustifolia Oil (Lavender) 2.0%</div>
                <div>Rosa Damascena Flower Oil (Rose) 3.0%</div>
                <div>Freesia Refracta Extract (Freesia) 2.5%</div>
