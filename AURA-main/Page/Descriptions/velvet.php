    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">VELVET</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    VELVET is a luxurious and smooth fragrance, inspired by the soft touch of rich velvet fabric.
                    Opening with juicy pear and pink pepper, it offers a gentle yet sparkling introduction. The heart
                    blooms with Bulgarian rose, heliotrope, and iris, creating a warm, floral elegance. The base features
                    creamy tonka bean, soft musk, and a hint of sandalwood, giving the fragrance depth and a lasting
                    cozy sophistication. Perfect for evening wear and special occasions, VELVET exudes charm and refined
                    allure.
                </p>
            </section>
            ...
            <section class="product-ingredients-2col">
                ...
                <div>Pyrus Communis Extract (Pear) 3.0%</div>
                <div>Pink Pepper Extract 2.0%</div>
                <div>Rosa Damascena Flower Oil (Bulgarian Rose) 4.0%</div>
                <div>Heliotropium Arborescens Extract (Heliotrope) 2.5%</div>
                <div>Iris Florentina Extract (Iris) 2.0%</div>
                <div>Tonka Bean Extract 2.5%</div>
