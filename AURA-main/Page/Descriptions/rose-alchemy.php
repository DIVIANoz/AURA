    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">ROSE ALCHEMY</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    ROSE ALCHEMY is a masterful floral-fruity composition that exudes mystery and elegance. The top
                    notes open with a sparkling
                    blend of lychee, bergamot, and red currant, creating a fresh, radiant introduction. The heart is a
                    luxurious bouquet of damask
                    rose, peony, and pink freesia, accentuated by soft hints of jasmine sambac and lily, evoking a
                    romantic and enchanting aura.
                    The dry-down reveals warm amber, white musk, and creamy sandalwood layered with subtle hints of
                    vanilla, leaving
                    a mesmerizing and long-lasting trail that captivates the senses. Perfect for special occasions and
                    evening allure.
                </p>
            </section>
            ...
            <section class="product-ingredients-2col">
                ...
                <div>Litchi Chinensis Extract (Lychee) 2.5%</div>
                ...
                <div>Freesia Alba Extract (Pink Freesia) 2.0%</div>
                <div>Jasminum Sambac Extract (Jasmine) 2.5%</div>
                <div>Vanilla Planifolia Extract (Vanilla) 2.0%</div>
