    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">MIDNIGHT</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    MIDNIGHT is a mysterious and intoxicating fragrance that evokes the allure of moonlit nights. The
                    opening is dominated by crisp notes of blackcurrant, bergamot, and a hint of violet leaf, offering a
                    cool and enigmatic start. The heart blooms with night-blooming jasmine, ylang-ylang, and
                    heliotrope, creating a seductive floral bouquet. The base features rich accords of patchouli, 
                    amber, and a touch of smoky vetiver, leaving a lingering trail that captivates and enchants. Ideal
                    for evening wear, MIDNIGHT embodies mystery, elegance, and sophistication.
                </p>
            </section>

            <section class="product-ingredients-2col">
                <div>Alcohol Denat. (Carrier) 75.0%</div>
                <div>Ribes Nigrum Extract (Blackcurrant) 3.0%</div>
                <div>Citrus Aurantium Bergamia Peel Oil (Bergamot) 2.5%</div>
                <div>Viola Odorata Leaf Extract (Violet Leaf) 2.0%</div>
                <div>Jasminum Grandiflorum Oil (Jasmine) 3.0%</div>
                <div>Cananga Odorata Oil (Ylang-Ylang) 2.5%</div>
                <div>Heliotropium Europaeum Extract (Heliotrope) 2.0%</div>
                <div>Pogostemon Cablin Leaf Oil (Patchouli) 3.0%</div>
                <div>Amber 2.5%</div>
                <div>Vetiveria Zizanoides Root Oil (Vetiver) 2.0%</div>
            </section>
        </div>
    </main>
