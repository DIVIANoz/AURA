    ...
    <main class="product-detail-2row-container">
        <div class="product-detail-2row-top">
            ...
            <div class="product-detail-right">
                <h1 class="product-title-main">ATLAS</h1>
        ...
        <div class="product-detail-2row-bottom">
            <section>
                ...
                <p class="product-description">
                    ATLAS is an adventurous and invigorating fragrance, designed for the modern explorer who embraces
                    bold journeys. Its top notes feature zesty bergamot and spicy cardamom, creating a lively and
                    energetic opening. The heart blends aromatic lavender and robust cedarwood, adding a grounding
                    complexity that balances the initial vibrancy. The base notes reveal a deep warmth of amber, vetiver,
                    and hints of leather, leaving a commanding and long-lasting trail. Atlas is ideal for daytime
                    sophistication or evening charisma, evoking confidence, strength, and timeless masculinity.
                </p>
            </section>
            ...
            <section class="product-ingredients-2col">
                ...
                <div>Elettaria Cardamomum Seed Oil (Cardamom) 2.5%</div>
                <div>Lavandula Angustifolia Oil (Lavender) 4.0%</div>
                <div>Cedrus Atlantica Bark Oil (Cedarwood) 3.5%</div>
                <div>Ambroxan (Synthetic Ambergris) 2.5%</div>
                <div>Vetiveria Zizanoides Root Oil (Vetiver) 3.0%</div>
            </section>
        </div>
    </main>
